        ...
        methods: {
            ...
            chooseMenu(index) {
                ...
                for (let i = 1; i < index + 1; i++) {
                    distance += document.querySelector('.menu_right>ul>li:nth-child(' + i + ')').offsetHeight
                }
